...
player_count_table = pd.DataFrame({"Total Players": [total_player_count]})
player_count_table
...
male_percent = "{:.2f}%".format(male_count /total_player_count * 100)
...
female_percent = "{:.2f}%".format(female_count / total_player_count * 100)
...
other_percent = "{:.2f}%".format(other_count / total_player_count * 100)
...
percentage_by_age = round(total_count_age / total_player_count * 100,2)
